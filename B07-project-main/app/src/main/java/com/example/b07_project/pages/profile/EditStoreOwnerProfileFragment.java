...
public class EditStoreOwnerProfileFragment extends Fragment {

    private EditText editTextFirstName;
    private EditText editTextLastName;
    private Button buttonSave;
    private SellerData oldSellerData;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        buttonSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SellerData data = new SellerData(newFirstName, newLastName, oldSellerData.getEmail(), oldSellerData.getShopId());
                FirebaseRepository.updateCurrentSellerData(data);
                NavHostFragment.findNavController(EditStoreOwnerProfileFragment.this).popBackStack();
            }
        });
    }
}
